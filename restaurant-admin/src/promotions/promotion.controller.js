...
export const createPromotionController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: 'Error al crear la promoción', error: err.message });
  }
};
...
export const getPromotionsController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: 'Error al obtener promociones', error: err.message });
  }
};
...
export const getPromotionByIdController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: 'Error al obtener la promoción', error: err.message });
  }
};
...
export const updatePromotionController = async (req, res) => {
  try {
    ...
    res
      .status(400)
      .json({ success: false, message: 'Error al actualizar la promoción', error: err.message });
  }
};
...
export const deletePromotionController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: 'Error al eliminar la promoción', error: err.message });
  }
};
