...
export const createInventoryController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: 'Error al crear el insumo', error: err.message });
  }
};
...
export const getInventoryController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: 'Error al obtener el inventario', error: err.message });
  }
};
...
export const getInventoryByIdController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: 'Error al obtener el insumo', error: err.message });
  }
};
...
export const updateInventoryController = async (req, res) => {
  try {
    ...
    res
      .status(400)
      .json({ success: false, message: 'Error al actualizar el insumo', error: err.message });
  }
};
...
export const deleteInventoryController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: 'Error al eliminar el insumo', error: err.message });
  }
};
