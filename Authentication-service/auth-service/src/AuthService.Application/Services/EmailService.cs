...
<a href='{verificationUrl}' style='background-color: #0d427a; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>
...
<a href='{resetUrl}' style='background-color: #a70011; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>
...
<p>Si no solicitaste esto, por favor ignora este correo y tu contraseña permanecerá sin cambios.</p>
    ...
    public async Task SendWelcomeEmailAsync(string email, string username)
    {
        ...
        var body = $@"
<h2>¡Bienvenido a FoodPilot, {username}!</h2>
