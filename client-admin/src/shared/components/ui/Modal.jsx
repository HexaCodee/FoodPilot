...
export const Modal = ({ isOpen, onClose, title, children, maxWidth = 'max-w-lg' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Panel */}
      <div className={`relative w-full ${maxWidth} bg-fp-surface border border-fp-border rounded-2xl shadow-2xl animate-fadeUp`}>
        {/* Header */}
...
export const ModalActions = ({ children }) => (
  <div className="flex justify-end gap-3 pt-4 border-t border-fp-border mt-4">
    {children}
  </div>
);
