const ROLE_MAP = {
  PLATFORM_ADMIN: {
    ...
    cls: 'bg-purple-900/40 text-purple-300 border-purple-700/40',
  },
  RESTAURANT_ADMIN: {
    label: 'Admin Restaurante',
    cls: 'bg-blue-900/40 text-blue-300 border-blue-700/40',
  },
...
const STATUS_MAP = {
  ...
  verified: {
    label: 'Verificado',
    cls: 'bg-emerald-900/40 text-emerald-400 border-emerald-700/40',
  },
...
export const RoleBadge = ({ role }) => {
  const { label, cls } = ROLE_MAP[role] ?? {
    label: role,
    cls: 'bg-fp-surface text-fp-muted border-fp-border',
  };
  return (
    <span
