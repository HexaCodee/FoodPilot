...
export const ProfilePage = () => {
  ...
  const handleUploadPic = async () => {
    ...
    try {
      ...
      const { data } = await updateProfile({ username: user?.username ?? username.trim(), profilePictureUrl: url });
        ...
        <div className="flex-1 min-w-0">
          ...
          {picFile && (
            <div className="mt-2 flex items-center gap-2">
              ...
              <button
                onClick={() => { setPicFile(null); setPicPreview(''); }}
                disabled={uploadingPic}
      ...
      <div className="bg-fp-surface border border-red-500/20 rounded-xl p-5">
        ...
        {confirmDelete ? (
          <div className="space-y-3">
            <p className="text-fp-text text-sm">¿Estás seguro? Esta acción <strong>no se puede deshacer</strong>.</p>
