...
import { getSalesReports, getUsageStats } from '../../../shared/apis/events.js';
import {
  BarChartIcon,
  TrendUpIcon,
  ClipboardIcon,
      ...
      <div className='bg-fp-surface border border-fp-border rounded-xl overflow-hidden'>
        ...
        {loading ? (
          ...
          <p className='text-fp-subtle text-sm text-center py-10'>
            Sin reportes de ventas para este restaurante
          </p>
        ) : (
    ...
    <div className='space-y-5'>
      ...
      <div className='bg-fp-surface border border-fp-border rounded-xl overflow-hidden'>
        ...
        {loading ? (
          ...
          <p className='text-fp-subtle text-sm text-center py-10'>
            Sin estadísticas de uso para este restaurante
          </p>
        ) : (
          <div className='overflow-x-auto'>
            <table className='w-full text-sm'>
