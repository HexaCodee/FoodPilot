...
exports.createReservationValidator = [
  ...
  body('reservedAt')
    .notEmpty()
    .withMessage('Fecha/hora requerida')
    .isISO8601()
    .withMessage('Fecha/hora inválida')
    .custom((value) => {
...
exports.cancelReservationValidator = [param('id').isMongoId().withMessage('ID inválido')];

// Reglas de validación para completar una reserva
exports.completeReservationValidator = [param('id').isMongoId().withMessage('ID inválido')];
